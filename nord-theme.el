...
;;;; +------------+
  (custom-theme-set-faces
    ...
    `(marginalia-date                ((,class (:foreground ,nord9))))
    ...
    `(marginalia-file-priv-dir       ((,class (:foreground ,nord9))))
    `(marginalia-file-priv-exec      ((,class (:foreground ,nord14))))
    ...
    `(marginalia-file-priv-read      ((,class (:foreground ,nord13))))
    `(marginalia-file-priv-write     ((,class (:foreground ,nord11))))
    ...
    `(marginalia-size                ((,class (:foreground ,nord14))))
