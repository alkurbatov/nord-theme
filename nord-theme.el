...
(unless (nord-display-truecolor-or-graphic-p)
  (error "Display cannot display nord colors!"))
...
;;;; +------------+
  (custom-theme-set-faces
    ...
    `(font-lock-bracket-face                  ((,class (:foreground ,nord8))))
    ...
    `(font-lock-escape-face                   ((,class (:foreground ,nord13))))
    ...
    `(whitespace-empty                      ((,class (:foreground ,nord-comment))))
    `(whitespace-hspace                     ((,class (:foreground ,nord-comment))))
    `(whitespace-indentation                ((,class (:foreground ,nord-comment))))
    `(whitespace-line                       ((,class (:background ,nord0))))
    `(whitespace-missing-newline-at-eof     ((,class (:foreground ,nord-comment))))
    `(whitespace-newline                    ((,class (:foreground ,nord-comment))))
    `(whitespace-space                      ((,class (:foreground ,nord-comment))))
    `(whitespace-space-after-tab            ((,class (:foreground ,nord-comment))))
    `(whitespace-space-before-tab           ((,class (:foreground ,nord-comment))))
    `(whitespace-tab                        ((,class (:foreground ,nord-comment))))
    ...
    `(marginalia-date                ((,class (:foreground ,nord-comment))))
    `(marginalia-documentation       ((,class (:foreground ,nord-comment))))
    `(marginalia-file-name           ((,class (:foreground ,nord-comment))))
    `(marginalia-file-owner          ((,class (:foreground ,nord-comment))))
    `(marginalia-file-priv-dir       ((,class (:foreground ,nord-comment))))
    `(marginalia-file-priv-exec      ((,class (:foreground ,nord-comment))))
    `(marginalia-file-priv-link      ((,class (:foreground ,nord-comment))))
    `(marginalia-file-priv-no        ((,class (:foreground ,nord-comment))))
    `(marginalia-file-priv-other     ((,class (:foreground ,nord-comment))))
    `(marginalia-file-priv-rare      ((,class (:foreground ,nord-comment))))
    `(marginalia-file-priv-read      ((,class (:foreground ,nord-comment))))
    `(marginalia-file-priv-write     ((,class (:foreground ,nord-comment))))
    `(marginalia-function            ((,class (:foreground ,nord-comment))))
    `(marginalia-installed           ((,class (:foreground ,nord-comment))))
    `(marginalia-key                 ((,class (:foreground ,nord-comment))))
    `(marginalia-lighter             ((,class (:foreground ,nord-comment))))
    `(marginalia-list                ((,class (:foreground ,nord-comment))))
    `(marginalia-mode                ((,class (:foreground ,nord-comment))))
    `(marginalia-modified            ((,class (:foreground ,nord-comment))))
    `(marginalia-null                ((,class (:foreground ,nord-comment))))
    `(marginalia-number              ((,class (:foreground ,nord-comment))))
    `(marginalia-off                 ((,class (:foreground ,nord-comment))))
    `(marginalia-on                  ((,class (:foreground ,nord-comment))))
    `(marginalia-size                ((,class (:foreground ,nord-comment))))
    `(marginalia-string              ((,class (:foreground ,nord-comment))))
    `(marginalia-symbol              ((,class (:foreground ,nord-comment))))
    `(marginalia-true                ((,class (:foreground ,nord-comment))))
    ...
    `(company-scrollbar-bg                     ((,class (:foreground ,nord0 :background ,nord6))))
    `(company-scrollbar-fg                     ((,class (:foreground ,nord0 :background ,nord-comment))))
    `(company-tooltip-scrollbar-thumb          ((,class (:foreground ,nord0 :background ,nord6))))
    `(company-tooltip-scrollbar-track          ((,class (:foreground ,nord0 :background ,nord-comment))))
    `(company-template-field                   ((,class (:foreground ,nord0 :background ,nord7))))
    `(company-tooltip                          ((,class (:foreground ,nord4 :background ,nord2))))
    `(company-tooltip-annotation               ((,class (:foreground ,nord8))))
    `(company-tooltip-annotation-selection     ((,class (:foreground ,nord8 :weight bold))))
   ...
   `(diff-hl-margin-change      ((,class (:foreground ,nord13 :background ,nord0))))
   `(diff-hl-margin-insert      ((,class (:foreground ,nord14 :background ,nord0))))
   `(diff-hl-margin-delete      ((,class (:foreground ,nord11 :background ,nord0))))
